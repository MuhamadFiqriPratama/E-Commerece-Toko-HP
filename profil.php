...
<body>
    <div class="container">
        <form action="simpandataregister.php" method="post">
            <div class="title">Tambah Profil</div>
            <div class="sub-title">Heavenly Store</div>
            <div class="input-box">
            ...
            <div class="input-box button">
                <input type="submit" value="Tambah Profil" name="profil">
            </div>
        </form>
        <div class="option">Sudah memiliki akun? <a href="index.php">Login</a></div>
