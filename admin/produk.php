        ...
        <div class="table-responsive shadow">
            <div class="table-wrapper">
                <div class="table-title bg-warning">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>Data Produk <b class="heading ms-2">Heavenly Store</b></h2>
                        </div>
                        <div class="col-sm-7">
                            <div class="tambah text-center">
                                <a href="tambahproduk.php" class="btn btn-dark"><i
                                        class="material-icons">&#xE147;</i><span>Tambah Produk</span></a>
                            </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($qproduk)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center"><?php echo "Rp. " . number_format($row["harga"]) . ",-"; ?>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-center"><?= $row["deskripsi"] ?></div>
                                </td>
                                <td class="d-flex">
                                    <a href="editproduk.php?idproduk=<?= $row["id"] ?>"
                                        class="btn btn-warning w-50 m-2 text-light">Edit</a>
                                    <a onclick="return confirm(`Yakin Hapus <?= $row['namaproduk'] ?>`)"
                                        href="hapusdata.php?idproduk=<?= $row["id"] ?>"
                                        class="btn btn-danger w-50 m-2 text-light">Hapus</a>
                                    </a>
                                </td>
                            </tr>
